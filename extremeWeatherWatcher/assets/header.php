<!DOCTYPE html>
<!-- header to be included on all visible pages -->
<html lang="en">
<head>
...
<body>
    <div class="nav-bar">
        ...
        <!-- logo, acts as a 'home' button to redirect to index.php -->
        ...
        <!-- hoverable dropdown for links to events by continent pages -->
        ...
        <!-- watchlist and profile links, appear only when user is logged in -->
        <?php
        ...
        <!-- Display different login/logout message whether the user logged in or not  -->
        <?php
            if (isset($_SESSION['userEmail'])) {
